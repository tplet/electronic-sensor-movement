...
#ifndef COM_OSTERES_AUTOMATION_SENSOR_MOVEMENT_ACTION_ACTIONMANAGER_H
#define COM_OSTERES_AUTOMATION_SENSOR_MOVEMENT_ACTION_ACTIONMANAGER_H
...
#endif //COM_OSTERES_AUTOMATION_SENSOR_MOVEMENT_ACTION_ACTIONMANAGER_H
